...
\input{\CHAPTERDIR/01/sec-players-get-the-power}
% \input{\SIDEBARDIR/the-ladder}
\input{\CHAPTERDIR/01/sec-the-fate-point-economy}
\input{\SIDEBARDIR/summary-aspects}
\input{\CHAPTERDIR/01/sec-aspects}
\input{\CHAPTERDIR/01/sec-resolution}
\input{\CHAPTERDIR/01/sec-skill-interactions}
\input{\SIDEBARDIR/time-track}
\input{\CHAPTERDIR/01/sec-dealing-with-time}
