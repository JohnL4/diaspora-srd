...
\index{command range}
\rulebox{Command range indicates leader communication range}
...
% Command range indicates how may zones a unit can be away from its leader and still be in communication with it.
