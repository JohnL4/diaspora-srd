...
\input{\SIDEBARDIR/system-attributes}
\input{\CHAPTERDIR/02/sec-systems}
\input{\CHAPTERDIR/02/sec-generation}
\input{\CHAPTERDIR/02/sec-linking-systems}
\input{\CHAPTERDIR/02/sec-construction-sequence}
\input{\CHAPTERDIR/02/sec-system-attributes}
