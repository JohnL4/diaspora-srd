...
\rulebox{Players select 15 skills for their character} and rank them in the \textbf{pyramid}: one at level 5, two at 4, three at 3, four at 2, and five at 1.
...
\rulebox[``Untrained'' skill use is at \Skill\ level -1]{An attempt to use any Skill that is not in the character's Skill pyramid does so at an effective Skill level of -1.}
